defmodule DmarcOpsWeb.UserLive.LoginTest do
  ...
  describe "user login - magic link" do
    test "sends magic link email when user exists", %{conn: conn} do
      ...
      assert DmarcOps.Repo.get_by!(DmarcOps.Accounts.UserToken, user_id: user.id).context ==
               "login"
    end
